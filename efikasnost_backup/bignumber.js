...
function divide(a, b){ return new BigNumber(a).divide(b).toString(); }
function add(a, b){ return new BigNumber(a).add(b).toString(); }
function multiply(a, b){ return new BigNumber(a).multiply(b).toString(); }